...
/// <summary>
/// Handler xử lý lấy toàn bộ danh sách chuyến đi cho Admin tuân thủ Clean Architecture
/// </summary>
public class GetAdminAllTripsQueryHandler : IRequestHandler<GetAdminAllTripsQuery, List<TripDto>>
{
    private readonly ITripRepository _tripRepository;

    public GetAdminAllTripsQueryHandler(ITripRepository tripRepository)
    {
        _tripRepository = tripRepository;
    }

    public async Task<List<TripDto>> Handle(GetAdminAllTripsQuery request, CancellationToken cancellationToken)
    {
        var trips = await _tripRepository.GetAllTripsForAdminAsync(cancellationToken);
